        ...
        >
          <div className="left mx-22">
           <Link  className="text-black" href={`/details/${tournament.id}`}>
               <div className="card-title text-black text-twire-light hover:underline hover:text-cyan-400 font-sans font-bold text-2xl mb-4"> 
          ...
          <div className="right">
            <div className="detail  mt-12 ">
              <Link  className="text-black" href={`/details/${tournament.id}`}>
            <button className="text-black  hover:underline  hover:text-cyan-400">DETAILS</button>
          </Link>
            </div>
          </div>
        </div>
